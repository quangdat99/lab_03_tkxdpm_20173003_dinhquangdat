...
public class PhysicalMediaEditDialog extends MediaEditDialog{
	...
	public void buildControls() {
		...
		if (t instanceof PhysicalMedia) {
			...
			JLabel barcodeLabel = new JLabel("ManhDS_20173253-Barcode");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel descriptionLabel = new JLabel("ManhDS_20173253-Description");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel quantityLabel = new JLabel("ManhDS_20173253-Quantity");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel weightLabel = new JLabel("ManhDS_20173253-Weight");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionWidthLabel = new JLabel("ManhDS_20173253-Dimension Width");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionHeightLabel = new JLabel("ManhDS_20173253-Dimension Height");
			c.gridx = 0;
			c.gridy = row;
			...
			row = getLastRowIndex();
			JLabel dimensionDepthLabel = new JLabel("ManhDS_20173253-Dimension Depth");
			c.gridx = 0;
			c.gridy = row;
