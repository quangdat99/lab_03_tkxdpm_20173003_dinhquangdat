...
public class MediaEditDialog extends ADataEditDialog<Media>{
	...
	public void buildControls() {
		...
		JLabel titleLabel = new JLabel("ManhDS_20173253-Title");
		c.gridx = 0;
		c.gridy = row;
		...
		row = getLastRowIndex();
		JLabel categoryLabel = new JLabel("ManhDS_20173253-Category");
		c.gridx = 0;
		c.gridy = row;
		...
		row = getLastRowIndex();
		JLabel costLabel = new JLabel("ManhDS_20173253-Cost");
		c.gridx = 0;
		c.gridy = row;
